...
contract PoolToken is IPoolToken, EvoERC20 {
    ...
    function _setFactory() external {
        require(factory == address(0), "Evo: FACTORY_ALREADY_SET");
        factory = msg.sender;
    }
        ...
        returns (uint256 mintTokens)
    {
        ...
        require(mintTokens > 0, "Evo: MINT_AMOUNT_ZERO");
        ...
        returns (uint256 redeemAmount)
    {
        ...
        require(redeemAmount > 0, "Evo: REDEEM_AMOUNT_ZERO");
    ...
    modifier nonReentrant() {
        require(_notEntered, "Evo: REENTERED");
        _notEntered = false;
        _;
        _notEntered = true;
    }
