...
contract Router01 is IRouter01, IEvoCallee {
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"b00fce42fa0edf10bba0ea63818435536116a230ddd725ef619065e1089f9cbf" // Borrowable bytecode keccak256
                    )
                )
            )
        );
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"6fdab5964df883a53791dd10eb5087b568c674f57a9f49821d0654b094601e1e" // Collateral bytecode keccak256
                    )
                )
            )
        );
